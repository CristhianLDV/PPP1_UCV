...
<div class="row">
    @php
        $cards = [
            ['icon' => 'ti-id-badge', 'label' => 'Total Empleados', 'value' => $data[0], 'iconBig' => 'ti-user'],
            ['icon' => 'ti-alarm-clock', 'label' => 'A Tiempo Porcentaje', 'value' => $data[3] . '%', 'iconBig' => 'ti-pie-chart'],
            ['icon' => 'ti-check-box', 'label' => 'A Tiempo Hoy', 'value' => $data[1], 'iconBig' => 'ti-check'],
            ['icon' => 'ti-alert', 'label' => 'Tarde Hoy', 'value' => $data[2], 'iconBig' => 'ti-timer'],
        ];
    @endphp
            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge badge-success badge-pill">{{ $data[1] + $data[2] }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Porcentaje Puntualidad
                        <span class="badge badge-info badge-pill">{{ $data[3] }}%</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Empleados Registrados
                        <span class="badge badge-primary badge-pill">{{ $data[0] }}</span>
                    </li>
                </ul>
            </div>
        </div>
